  ...
  - block: features
    ...
    content:
      ...
      text: >
            ...
            <p class="text-2xl font-light" style="font-family:Times New Roman, sans-serif;">Please send your CV to <span style="text-decoration: underline;">yankai.cao@ubc.ca.</span>. </p> 
            <p class="text-2xl font-light" style="font-family:Times New Roman, sans-serif;">Please <b>provide the following information:</b>  degree program and university, graduation year, GPA, class rank, English proficiency test score, desired start date, research summary, and future research plans (for postdocs). </p>
